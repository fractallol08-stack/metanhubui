...
function LibraryV2:Container(Name)
    ...
    Container = {
        ...
        In = function()
            ...
            local Tween = game:GetService("TweenService"):Create(Container.Container, TweenInfo.new(0.3), {Size = u2(0, 360, 0, 50)})
            Tween:Play()
        ...
        Out = function()
            ...
            local Tween = game:GetService("TweenService"):Create(Container.Container, TweenInfo.new(0.3), {Size = u2(0, 360, 0, ((65)+55*#Container.Assets))})
            Tween:Play()
        ...
        if Container.State then
            ...
            for i,v in pairs(Container.Drops) do
                if v.State == false then
                    Tween(v.Asset, {Size = u2(0, 345 , 0, 50)}, 0.01)
...
function LibraryV2:Dropdown(Name, List, Callback)
            ...
            for i,v in pairs(Dropdown.List) do
                ...
                New_Template.MouseButton1Down:Connect(function()
                    if Dropdown.State == false then
                        ...
                        State = not State
                        Tween(Dropdown.Asset, {Size = u2(0, 345 , 0, 50)}, 0.35)
    ...
    Dropdown.Asset.MouseButton1Down:Connect(function(X, Y)
        ...
        if State then
            ...
            Dropdown.Debounce = true
            State = not State
            Tween(Dropdown.Asset, {Size = u2(0, 345 , 0, Dropdown.Other.ExtensionSize)}, 0.35)
